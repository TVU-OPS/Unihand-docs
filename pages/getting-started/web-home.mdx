# **Hướng dẫn cài đặt và chạy web-home**

## **Giới thiệu**
Thư mục `web-home` chứa mã nguồn của trang chủ được xây dựng bằng **Noodl**. Dưới đây là hướng dẫn từng bước để cài đặt **Noodl**, thiết lập môi trường và chạy dự án.
# ![UniHand Banner](/img/web_home.png)
